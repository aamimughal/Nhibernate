        ...
        public static ISessionFactory GetNHSF()
        {
            try
            {
                ...
                if (SF == null)
                {
                    ...
                    NHConfig.SetProperty("connection.connection_string", "Server=localhost;Database=marchbatchdb;User ID=root;Password=pakistan;CharSet=utf8;");

                    NHConfig.AddAssembly("NHibernaterevision");
